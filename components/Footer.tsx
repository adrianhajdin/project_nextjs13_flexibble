        ...
        <div className="flex flex-wrap md:justify-between justify-center items-start gap-12 w-full">
            <div className="flexStart flex-col max-w-[300px]">
                ...
                <div className="text-start text-sm font-normal mt-5">
                    Flexibble: Empowering developers to connect, collaborate, and advance. Join the leading community for developers to showcase their skills, collaborate on projects, and unlock career opportunities.
                </div>
            </div>
